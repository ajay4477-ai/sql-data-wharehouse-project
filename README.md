...
Welcome to the <b>Data Warehouse and Analytics Project</b> repository!🚀<br> 
...
<ul>
  ...
  <li><b>Integration:</b> Combine both source systems into a single, user-friendly data model designed for analytical queries.</li>
